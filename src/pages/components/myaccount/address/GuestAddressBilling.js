...
const GuestAddressBilling = ({ backCLick, handleClick, paymentClick }) => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            sessionStorage.setItem('BillingAddressData', JSON.stringify(data));
...
export default GuestAddressBilling;