...
const Paragraph = ({ title, textAlign, color, width, shortDescription, readjustifytext, lineclamp }) => {
    ...
    const line = lineclamp === '2' ? 'line-clamp-2' : 'line-clamp-3';
        ...
        return (
            <div>
                {showFull ? (
                    ...
                    <p className={`text-base font-dm ${alignmentClass} ${textColor} ${line} overflow-hidden `} style={titleStyle}>{title}</p>
                )}
