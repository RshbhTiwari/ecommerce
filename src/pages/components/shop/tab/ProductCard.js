...
//     const [errorMessages, setErrorMessages] = useState({}); // Changed here
//     const isHomePath = location.pathname === '/';

//     const handleVariantClick = (productId, variant) => {
//         setSelectedVariants(prev => ({ ...prev, [productId]: { variant, value: null } }));
//         setShowOptions(prev => ({ ...prev, [productId]: true }));
//         setErrorMessages(prev => ({ ...prev, [productId]: '' })); // Clear specific error message
//     };
...
//         }));
//         setShowOptions(prev => ({ ...prev, [productId]: false }));
//         setErrorMessages(prev => ({ ...prev, [productId]: '' })); // Clear specific error message
//     };
...
//             setErrorMessages(prev => ({ ...prev, [productId]: 'Please select a variant and its value' })); // Set specific error message
...
//         setSelectedVariants(prev => ({
//             ...prev,
//             [productId]: { variant: null, value: null }
//         }));
//     };
...
//                     key={index}
//                 >
//                     <div className='flex flex-col justify-center items-center px-4' style={{
...
//                         <p className='text-red-500 font-dm text-sm pb-2'>{errorMessages[item.id]}</p>

//                         {showOptions[item.id] && selectedVariants[item.id] && (
//                             <div className='w-full'>
//                                 <h2 className="text-lg font-dm text-[#00a762] text-center">Select Variant : {selectedVariants[item.id].variant}:</h2>
...
//                                             <li
//                                                 key={value.id}
//                                                 className="border border-emerald-200 p-2 mb-2 cursor-pointer flex justify-between items-center"
//                                                 onClick={() => handleValueClick(item.id, value)}
//                                             >
//                                                 <p className='m-0 p-0 text-sm font-dm text-[#072320]'>{value.size}</p>
//                                                 <div>
//                                                     <p className='m-0 p-0 text-sm font-dm text-[#072320]'>Price : ₹{value.prize}</p>
//                                                     <p className='m-0 p-0 text-sm font-dm text-[#072320]'>Discount Price : ₹{value.discount_price}</p>
//                                                 </div>
//                                             </li>
//                                         ))}
//                                 </ul>
...
//                         <div className="flex items-center gap-2 text-[#00A762]  text-center font-dm text-lg capitalize font-medium pb-2 ">
//                             {selectedVariants[item.id]?.value ? (
//                                 <div className='flex flex-col w-full'>


//                                         <h1 className="text-lg font-dm text-[#00a762] text-center">Variant: {selectedVariants[item.id].variant}</h1>
//                                         <p className="text-lg font-dm text-[#00a762] text-center">{selectedVariants[item.id].value.size}</p>



//                                     {selectedVariants[item.id].value.discount_price ? (
//                                         <div className='mt-2'>
//                                             <span className="block text-xs line-through">₹{selectedVariants[item.id].value.prize}</span>
//                                             <span className="block">₹{selectedVariants[item.id].value.discount_price}</span>
//                                         </div>
//                                     ) : (
//                                         <h2 className="text-[#00A762] font-dm text-lg capitalize font-medium pb-2">
//                                             ₹{selectedVariants[item.id].value.prize}
//                                         </h2>
//                                     )}
//                                 </div>
//                             ) : (
...
//             {allProducts?.map((item, index) => (
//                 <div
//                     className={` ${isHomePath ? 'lg:col-span-3 md:col-span-6' : 'xl:col-span-4 lg:col-span-6 md:col-span-12 '}
//                      col-span-12 flex flex-col justify-between relative h-full items-center rounded-lg border-2 border-[#072320]`}
//                     key={index}
//                 >
//                     <div
//                         className='flex justify-center items-center bg-[#00A762] cursor-pointer p-4 rounded-lg mt-3 mb-2 mx-6 relative'
...
//                         <p className='text-red-500 font-dm text-sm '>{errorMessages[item.id]}</p>
...
//                                 {item?.variant_value
//                                         ?.find(v => v?.variant === selectedVariants[item?.id]?.variant)
//                                         ?.multiple_values && Array.isArray(item.variant_value.find(v => v?.variant === selectedVariants[item?.id]?.variant).multiple_values) ?
//                                      item.variant_value.find(v => v?.variant === selectedVariants[item?.id]?.variant).multiple_values.map(value => (
//                                      <li
//                                     key={value.id}
//                                          className="border border-emerald-200 p-2 mb-2 cursor-pointer flex justify-between items-center"
//                                       onClick={() => handleValueClick(item?.id, value)}
...
//                                         <p className='m-0 p-0 text-sm font-dm text-[#072320]'>{value?.size}</p>
//                                           <div>
//                                       <p className='m-0 p-0 text-sm font-dm text-[#072320]'>Price : ₹{value?.price}</p>
//                                            <p className='m-0 p-0 text-sm font-dm text-[#072320]'>Discount Price : ₹{value?.discount_price}</p>
//                                           </div>
//                                              </li>
//                                            )) : (
//                                     <li className='m-0 p-0 text-sm font-dm text-[#072320] text-center'>No values available</li> // Optional: Handle the case where there are no values
//                                        )}
//                                     </ul>
//                             </div>
//                         )}
...
//                                     {selectedVariants[item.id].value.discount_price ? (
//                                         <div className='mt-2'>
//                                             <span className="block text-xs line-through">₹{selectedVariants[item.id].value.price}</span>
//                                             <span className="block">₹{selectedVariants[item.id].value.discount_price}</span>
//                                         </div>
//                                     ) : (
//                                         <h2 className="text-[#00A762] font-dm text-lg capitalize font-medium pb-2">
//                                             ₹{selectedVariants[item.id].value.price}
//                                         </h2>
//                                     )}
//                                 </div>
//                             ) : (
