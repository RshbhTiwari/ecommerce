...
const WishlistPagination = ({ wishlistdata }) => {
    ...
    const currentwishlist = wishlistdata.slice(indexOfFirstProduct, indexOfLastProduct);

    const totalPages = Math.ceil(wishlistdata.length / productsPerPage);
    ...
    return (
        <>
            <WishlistTable wishlistitems={currentwishlist} />
